...
CONF_VALVE_CURVE_COMPENSATION_ENABLED = "valve_curve_compensation_enabled"
...
DEFAULT_KINT = 0.6
DEFAULT_KEXT = 0.02
DEFAULT_VALVE_CURVE_COMPENSATION_ENABLED = True
...
DEFAULT_OPTIONS: dict[str, str | None | int | bool | float] = {
    ...
    CONF_VALVE_CURVE_COMPENSATION_ENABLED: DEFAULT_VALVE_CURVE_COMPENSATION_ENABLED,
